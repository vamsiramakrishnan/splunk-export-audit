...
def handler(ctx, data: io.BytesIO=None):
    ...
    oci_audit_events_JSON = http_event_collector(token= os.environ['splunk_hec_token'], 
                                                 host = os.environ['source_host_name'], input_type = 'json',
                                                 http_event_port ='8088', http_event_server= os.environ['splunk_url'])
    ...
    return response.Response(
        ctx, response_data=oci_audit_events_JSON.sendEvent(payload),
